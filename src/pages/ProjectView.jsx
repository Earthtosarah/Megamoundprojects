          ...
          {loading ? (
            ...
            <>
              ...
              {activeView === 'Resources' && (
                <ResourcesView resources={resources} projectId={project.id} isAdmin={isAdmin} onRefresh={fetchAll} />
              )}
              {activeView === 'Charts' && (
...
// ─── TASKS VIEW ───────────────────────────────────────────────
function TasksView({ weekTasks, sections, activeWeek, weekPct, canEdit, isAdmin, onUpdateStatus, onUpdateNote, onAddTask, projectId, onRefresh }) {
  return (
    <div>
